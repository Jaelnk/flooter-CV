...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text('JHAEL DARIO NICOLALDE MOLINA'),
      ),
      body: Column(
        children: [
          // firstColumn,
            ...
            children: [
              ...
              Row(
                children: const [
                  ...
                  Text("   jhaelnicolalde_9c@hotmail.com")
                ],
              ),
              Row(
                children: const [
              ...
              const SizedBox(
                ...
                child: FittedBox(
                    child: Text(
                        "Html, Css, JavaScript, Java, Flutter, Python y Linux")),
              ),
              Container(
                padding: const EdgeInsets.symmetric(vertical: 5),
                child: const Text(
  ...
  Future<void> _createPDF() async {
    ...
    saveAndLaunchFile(bytes, "Curriculum.pdf");
  }
}
